...
export default function EUSection() {
  ...
  return (
    <section className="flex items-center justify-center w-full px-8 bg-white">
      <div className="flex w-[80%] max-w-6xl mt-24 mb-24 bg-white shadow-lg rounded-2xl overflow-hidden h-[480px]">
        ...
        {/* RIGHT SIDE - Text */}
        <div
          className="w-1/2 h-full bg-[#DFF5E4] px-10 py-6 flex flex-col justify-start overflow-y-auto 
        ...
        >
          <h4 className="text-[20px] font-bold text-gray-900 mb-2">
            Why We Built RePut
          </h4>
          <h2 className="text-[28px] font-bold text-gray-900 mb-4 leading-snug">
            Build For Making Companies <br /> Future Ready
